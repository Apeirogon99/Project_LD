...
//	}
//
//	AClientHUD* clientHUD = Cast<AClientHUD>(session->GetHUD());
...
//				SendBufferPtr pakcetBuffer = FIdentityClientPacketHandler::MakeSendBuffer(session, emailVerifiedPacket);
//				session->Send(pakcetBuffer);
//			});
//
