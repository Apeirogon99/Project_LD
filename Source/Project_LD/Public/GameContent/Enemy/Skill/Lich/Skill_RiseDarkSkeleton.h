...
#include "Skill_RiseDarkSkeleton.generated.h"

UCLASS()
class PROJECT_LD_API ASkill_RiseDarkSkeleton : public AActor, public IEnemySkillInterface
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ASkill_RiseDarkSkeleton();
