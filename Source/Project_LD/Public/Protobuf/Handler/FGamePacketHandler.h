...
enum class EPakcetID: uint16
{
	...
	S2C_HitEnemy = 2058,
	S2C_DeathEnemy = 2059,
	S2C_DisAppearGameObject = 2060,
	C2S_LoadInventory = 2061,
	S2C_LoadInventory = 2062,
	C2S_InsertInventory = 2063,
	S2C_InsertInventory = 2064,
	C2S_UpdateInventory = 2065,
	S2C_UpdateInventory = 2066,
	C2S_DeleteInventory = 2067,
	S2C_DeleteInventory = 2068,
	S2C_RollbackInventory = 2069,
	C2S_ReplaceEqipment = 2070,
	S2C_ReplaceEqipment = 2071,
	S2C_LoadSkillTree = 2072,
	C2S_UpdateSkillTree = 2073,
	S2C_UpdateSkillTree = 2074,
	C2S_SetUseKeyAction = 2075,
	S2C_SetUseKeyAction = 2076,
	C2S_PressedUseKeyAction = 2077,
	C2S_ReleaseUseKeyAction = 2078,
	S2C_ResponseUseKeyAction = 2079,
	S2C_AppearSkill = 2080,
	S2C_ReactionSkill = 2081,
	S2C_EndReactionSkill = 2082,
	S2C_SkillCoolTime = 2083,
	S2C_PushBuff = 2084,
	S2C_ReleaseBuff = 2085,
	S2C_DebugBox = 2086,
	S2C_DebugCircle = 2087,
	C2S_RequestEnterDungeon = 2088,
	S2C_RequestEnterDungeon = 2089,
	S2C_ResponseEnterDungeon = 2090,
	C2S_CompleteLoadDungeon = 2091,
	S2C_WaitingLoadDungeon = 2092,
	S2C_CompleteLoadDungeon = 2093,
	S2C_EnterPortal = 2094,
	S2C_LeavePortal = 2095,
	S2C_PlaySequence = 2096,
	C2S_SkipSequence = 2097,
	S2C_SkipSequence = 2098,
	S2C_EndSequence = 2099,
	C2S_StartPack = 2100,
	S2C_StartPack = 2101,
};
*/
...
public:
	static void Init(PacketFunc inPacketFunc[UINT16_MAX])
	{
		...
		inPacketFunc[static_cast<uint16>(EPakcetID::S2C_DeathPlayer)] = [](ANetworkController* controller, BYTE* buffer, int32 len) { return FClientPacketHandler::HandlePacket<Protocol::S2C_DeathPlayer>(Handle_S2C_DeathPlayer, controller, buffer, len); };
		inPacketFunc[static_cast<uint16>(EPakcetID::S2C_RevivePlayer)] = [](ANetworkController* controller, BYTE* buffer, int32 len) { return FClientPacketHandler::HandlePacket<Protocol::S2C_RevivePlayer>(Handle_S2C_RevivePlayer, controller, buffer, len); };
	...
	static SendBufferPtr MakeSendBuffer(ANetworkController* controller, Protocol::C2S_RevivePlayer& pkt) { return FClientPacketHandler::MakeSendBuffer(controller, pkt, static_cast<uint16>(EPakcetID::C2S_RevivePlayer)); }
	...
	static SendBufferPtr MakeSendBuffer(ANetworkController* controller, Protocol::C2S_StartPack& pkt) { return FClientPacketHandler::MakeSendBuffer(controller, pkt, static_cast<uint16>(EPakcetID::C2S_StartPack)); }
